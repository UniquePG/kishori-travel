...
export default function PackageModal({
        ...
        itinerary: [
          {
            dayNumber: 1,
            title: "Arrival",
            description: "Arrive at the destination and check-in.",
          },
        ],
        terms: [""],
      });
  ...
  const removeItineraryDay = (index) => {
    setFormData((prev) => {
      ...
      return {
        ...prev,
        itinerary: newItinerary.map((item, i) => ({
          ...item,
          dayNumber: i + 1,
        })),
      };
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-0.5">
              Fill in the details to publish your tour package.
            </p>
          </div>
          <button
            onClick={onClose}
              ...
              <div className="p-5 rounded-2xl bg-amber-50/70 border border-amber-100 space-y-4">
                ...
                <label className="flex items-center gap-3 cursor-pointer group w-fit">
                  ...
                  <span className="text-sm font-semibold text-slate-800">
                    Show under Upcoming on website
                  </span>
                </label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-amber-900/80 ml-1">
                      Upcoming label (optional)
                    </label>
                    <input
                      name="upcomingLabel"
            ...
            <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-slate-500 -mt-1">
                  Example: Double sharing ₹6300, Triple ₹6000. Keep
                  &quot;Current price&quot; as your headline list price (e.g.
                  lowest tier).
                </p>
                {formData.roomSharingOptions.length === 0 ? (
                  <p className="text-sm text-slate-400 font-medium py-4 text-center border border-dashed border-slate-200 rounded-2xl">
                    No room-sharing rows. Add rows to show a breakdown on the
                    public itinerary.
                  </p>
                ) : (
                      ...
                      >
                        <div className="flex-1 space-y-1">
                          ...
                          <input
                            ...
                            value={row.label}
                            onChange={(e) =>
                              updateRoomSharingRow(idx, "label", e.target.value)
                            }
                        ...
                        <div className="w-full sm:w-36 space-y-1">
                          ...
                          <input
                            ...
                            value={row.price}
                            onChange={(e) =>
                              updateRoomSharingRow(idx, "price", e.target.value)
                            }
                            className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-sm font-medium"
                          />
                        </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-11 pr-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-orange-500/5 focus:border-orange-500 outline-none transition-all font-normal text-slate-900"
                        />
                      </div>
                    </div>
            ...
            <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-orange-600 text-white text-xs font-semibold rounded-xl hover:bg-orange-700 transition-all shadow-lg shadow-orange-600/20 active:scale-95"
                >
                  <Plus className="h-3.5 w-3.5" />
                  Add Day
                </button>
              ...
              {formData.itinerary.length === 0 ? (
                ...
                <div className="space-y-6">
                  {formData.itinerary.map((day, idx) => (
                    <div
                      key={idx}
                      className="group relative bg-slate-50/50 hover:bg-white border border-slate-100 hover:border-orange-200 rounded-xl p-6 transition-all"
                    >
                      <div className="flex gap-6">
                        <div className="flex flex-col items-center shrink-0">
                          <div className="w-12 h-12 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center font-semibold text-sm ring-4 ring-orange-50">
                            {day.dayNumber}
                          </div>
                        ...
                        <div className="flex-1 space-y-4">
                          <div className="flex items-center justify-between gap-4">
                            <input
                              ...
                              className="flex-1 bg-transparent border-none text-base font-semibold text-slate-900 placeholder:text-slate-300  focus:outline-none p-0"
                            />
                            <button
                              type="button"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {formData.inclusions
                      ...
                      .map((item, idx) => {
                        const realIdx = formData.inclusions.findIndex(
                          (inc) => inc === item,
                        );
                        return (
                          <div
                          ...
                          >
                            <input
                              ...
                              value={item.title}
                              onChange={(e) =>
                                updateInclusion(realIdx, e.target.value)
                              }
                              className="flex-1 px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-semibold text-slate-700 placeholder:text-slate-300 focus:bg-white outline-none transition-all"
                            />
                            <button
                              type="button"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-base font-semiblack text-slate-900">
                        What's Excluded
                      </h3>
                    </div>
                    <button
            ...
            <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] text-slate-400 font-medium ml-1 mt-2 flex items-center gap-1.5">
                  ...
                  Each term will be displayed as a separate point in the package
                  details.
                </p>
              </div>
            </div>
        ...
        <div className="p-6 border-t border-slate-100 flex items-center justify-between shrink-0 bg-slate-50/50 rounded-b-[2.5rem]">
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-3 rounded-2xl text-sm font-semibold text-slate-500 hover:bg-slate-100 transition-all active:scale-95"
            >
              Discard
            </button>
            <button
              ...
              className="px-10 py-3.5 bg-[#e8611a] text-white rounded-2xl text-sm font-semibold shadow-xl shadow-[#e8611a]/20 hover:bg-[#e8611a]/80 hover:shadow-[#e8611a]/20 active:scale-[0.98] transition-all disabled:opacity-50 disabled:pointer-events-none flex items-center gap-2"
            >
              {isLoading
                ? "Saving..."
                : editingPackage
